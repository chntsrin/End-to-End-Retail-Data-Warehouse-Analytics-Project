...
This project demonstrates a complete Data Analytics lifecycle, transforming raw retail transactional data into a **Data Warehouse** in MS SQL Server using **Medallion Architecture**. The final result is a professional **Power BI Dashboard** that help business stakeholders to make data-driven decisions regarding sales, profitability.
